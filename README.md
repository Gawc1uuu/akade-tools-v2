...
* *Wskazówka:* W folderze projektu kliknij prawym przyciskiem myszy w puste miejsce (z wciśniętym Shift) i wybierz "Otwórz okno PowerShell tutaj" lub wpisz `cmd` w pasku adresu folderu.
...
*Poczekaj chwilę, aż zobaczysz komunikat o uruchomieniu kontenera.*
4. **Wgraj strukturę bazy danych:**
...
*Powinieneś zobaczyć zielony komunikat o sukcesie.*
5. **Uruchom aplikację:**
